...
import static wci.intermediate.icodeimpl.ICodeNodeTypeImpl.FUNCTION;
...
public class DeclaredRoutineParser extends DeclarationsParser {
    ...
    private static final EnumSet<PascalTokenType> COMMA_SET = EnumSet.of(COMMA, COLON, IDENTIFIER, RIGHT_PAREN,
            SEMICOLON);
    static {
    ...
    private ArrayList<SymTabEntry> parseParmSublist(Token token,
        ...
        ArrayList<SymTabEntry> sublist = variableDeclarationsParser.parseIdentifierSublist(
