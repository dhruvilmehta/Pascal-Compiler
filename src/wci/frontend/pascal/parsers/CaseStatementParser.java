...
public class CaseStatementParser extends StatementParser {
    ...
    private static final EnumSet<PascalTokenType> CONSTANT_START_SET = EnumSet.of(IDENTIFIER, INTEGER, PLUS, MINUS,
            STRING);
    ...
    private ICodeNode parseConstant(Token token, HashSet<Object> constantSet)
        ...
        switch ((PascalTokenType) token.getType()) {
            ...
            case STRING: {
                constantNode = parseCharacterConstant(token, (String) token.getValue(),
                        sign);
                break;
            }
            default: {
