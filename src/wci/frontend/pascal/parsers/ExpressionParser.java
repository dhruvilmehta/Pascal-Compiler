...
public class ExpressionParser extends StatementParser {
    ...
    private static final EnumSet<PascalTokenType> REL_OPS = EnumSet.of(EQUALS, NOT_EQUALS, LESS_THAN, LESS_EQUALS,
    ...
    private static final EnumSet<PascalTokenType> MULT_OPS = EnumSet.of(STAR, SLASH, DIV, PascalTokenType.MOD,
            PascalTokenType.AND);// Map multiplicative operator tokens to node
    // types.
    ...
    private ICodeNode parseFactor(Token token)
        ...
        switch ((PascalTokenType) tokenType) {
            ...
            case NOT: {
                ...
                rootNode = ICodeFactory.createICodeNode(ICodeNodeTypeImpl.NOT);// Parse the factor. The NOT node adopts
                                                                               // the factor node as its child.
