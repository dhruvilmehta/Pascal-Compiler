...
public class Predefined {
    ...
    /**
     * Enter a standard procedure or function into the symbol table
     * stack.
     * 
     * @param symTabStack the symbol table stack to initialize.
    ...
    private static void initializeConstants(SymTabStack symTabStack) {
        ...
        falseId.setAttribute(CONSTANT_VALUE, Integer.valueOf(0));
        ...
        trueId.setAttribute(CONSTANT_VALUE, Integer.valueOf(1));
