...
public class AssignmentGenerator extends StatementGenerator {
    ...
    private static final String PAD_BLANKS = "PaddedString.blanks(II)Ljava/lang/StringBuilder;";
    private static final String APPEND_STRING = "java/lang/StringBuilder.append(Ljava/lang/String;)" +
            "Ljava/lang/StringBuilder;";
    private static final String APPEND_CHARSEQUENCE = "java/lang/StringBuilder.append(Ljava/lang/CharSequence;)" +
            "Ljava/lang/StringBuilder;";
    private static final String STRINGBUILDER_SUBSTRING = "java/lang/StringBuilder.substring(II)Ljava/lang/String;";
    private static final String STRING_SUBSTRING = "java/lang/String.substring(II)Ljava/lang/String;";
