...
public class ExpressionGenerator extends StatementGenerator {
     ...
     * @param last           true if this is the variable's last subscript, else
     *                       false.
    ...
    private static final EnumSet<ICodeNodeTypeImpl> ARITH_OPS = EnumSet.of(ADD, SUBTRACT, MULTIPLY, FLOAT_DIVIDE,
            INTEGER_DIVIDE, MOD);
