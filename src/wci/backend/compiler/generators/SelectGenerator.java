...
import static wci.backend.compiler.Instruction.LOOKUPSWITCH;
...
public class SelectGenerator extends StatementGenerator {
    ...
    public void generate(ICodeNode node)
        ...
        ArrayList<ValueLabelPair> pairs = processSelectBranches(selectChildren, branchLabels);
     ...
     */
    private ArrayList<ValueLabelPair> processSelectBranches(ArrayList<ICodeNode> selectChildren,
